    ...
    <>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5 space-y-1 text-[14px]">
          ...
          <li><strong className="text-black text-[16px] block">Order Food on Train</strong>Get fresh &amp; delicious meals delivered right to your seat with our <Link href="/food-booking" className="text-blue-600">&#39;Order Food on Train&#39;</Link>  feature.</li>
