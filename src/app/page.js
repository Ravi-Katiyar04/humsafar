    ...
    <>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5 space-y-1 text-[14px]">
          ...
          <li><strong className="text-black text-[16px] block">Tatkal Booking</strong> <Link href="/tatkal-railway-reservation" className="text-blue-600"> Tatkal ticket booking</Link>  facility enables a passenger to book a ticket one day in advance of the actual date of journey. It can be booked online at ixigo easily. Tatkal booking opens at 10 AM for AC Classes and 11 AM for Non-AC Classes one day in advance, excluding the journey date.</li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-5 space-y-1 text-[14px]">
          ...
          <li><strong className="text-black text-[16px] block">Seat Availability and Enquiry</strong> Use our <Link href="/train-seat-availability" className="text-blue-600">train seat availability</Link>    feature to find out the seat or berth availability on your train and check the lowest train ticket price. You can make online IRCTC train ticket reservations according to your preferred options - date of travel, train halt in minutes and IRCTC train route.</li>

          <li><strong className="text-black text-[16px] block">Order Food on Train</strong>Get fresh &amp; delicious meals delivered right to your seat with our <Link href="/order-food-in-train" className="text-blue-600">&#39;Order Food on Train&#39;</Link>  feature.</li>
